<template>
    <div class="content-tabel">
        <div class="card">
            ...
            <DataTable ref="dt" :value="data" v-model:selection="selectedobats" dataKey="id" :paginator="true" :rows="10" :filters="filters"
        ...
        <Dialog v-model:visible="createDialog" :style="{ width: '450px' }" header="Tambah Obat" :modal="true" class="p-fluid">
            <!-- Gambar (opsional) -->
            <img v-if="data.image" :src="`https://primefaces.org/cdn/primevue/images/obat/${data.image}`" :alt="data.image" class="block m-auto pb-3" />
        ...
        <Dialog v-model:visible="editDialog" :style="{ width: '450px' }" header="Edit Data Obat" :modal="true" class="p-fluid">
            <!-- Gambar -->
            <img v-if="obat.image" :src="`https://primefaces.org/cdn/primevue/images/obat/${obat.image}`" :alt="obat.image" class="block m-auto pb-3" />
